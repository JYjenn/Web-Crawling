...
- 또한, **업계 흐름과 관련 시장에 대해 원활히 조사**할 수 있음 👍
<br>

## ⚡ 어떻게 하는가?
- 페이지 개발자도구와 BeautifulSoup & Selenium 라이브러리로! :star2:
- _nhis_PAP_product_list_page_crawling.py: 각 제조사의 제품 개수_
- _nhis_PAP_All_product_info_list_crawling.py: 각 제조사의 제품종류 및 제품명 리스트_
